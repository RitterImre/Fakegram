...
public class EditProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseDatabase.getInstance(fireURL).getReference().child("Users").child(firebaseAuth.getUid()).addValueEventListener(new ValueEventListener() {
            @Override
    ...
    private void updateProfile() {
        ...
        FirebaseDatabase.getInstance(fireURL).getReference().child("Users").child(firebaseAuth.getUid()).updateChildren(map);
            ...
            uploadTask.continueWithTask(new Continuation() {
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    if (task.isSuccessful()) {
                        ...
                        FirebaseDatabase.getInstance(fireURL).getReference().child("Users").child(firebaseAuth.getUid()).child("profileImage").setValue(url);
                        pd.dismiss();
                    } else {
