...
import com.mobilalk.fakegram.Adapters.CommentAdapter;
...
public class CommentActivity extends AppCompatActivity {
    ...
    private void putComment() {
        ...
        DatabaseReference databaseReference = FirebaseDatabase.getInstance(fireURL).getReference().child("Comments").child(postId);
    ...
    private void getUserImage() {
        ...
        FirebaseDatabase.getInstance(fireURL).getReference().child("Users").child(firebaseUser.getUid()).addValueEventListener(new ValueEventListener() {
            @Override
